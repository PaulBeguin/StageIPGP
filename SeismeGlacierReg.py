...
def create_file_result(dl,Ltot,type_law,results_path,theme_name):
    
    results_filename = "Results" + theme_name + "dl"+ str(int(dl))+ "Ltot" + str(int(Ltot/1000)) + "kmHHTtypelaw"+str(type_law)+".npz"
    ...
    while results_filename in file_list :
        results_filename = "Results" + theme_name + "dl"+ str(int(dl))+ "Ltot" + str(int(Ltot/1000)) + "kmHHTtypelaw"+str(type_law) + "V" + str(i) +".npz"
        i +=1
    
    return(results_filename)


def create_folder_figure(save_figure_path,theme_name):

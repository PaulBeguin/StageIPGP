...
results_filename = "ResultsTestdl500Ltot40kmHHTtypelaw.npz"
...
m = 1/3
Cc = 0.4
type_law = 0 #0=Weertman et 1=Tsai
...
# Appel class Glacier
glacier = SeismeGlacier.Glacier(rho_glace,rho_eau,H,alpha_glacier,g,E,Cw,m,Cc,type_law,ud_reg,Np,Ltot,h_im)
...
save_folder_name = '1 juillet Ltot40km typelaw'
